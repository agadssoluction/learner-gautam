...
function xl(e) {
    return JSON.stringify(e, (e, t) => El(t) ? Object.keys(t).sort().reduce((e, n) => (e[n] = t[n], e), {}) : t)
}
...
function J(e) {
    let t = !1,
        ...
        l = () => cl.isFocused() && (e.networkMode === `always` || Bl.isOnline()) && e.canRun(),
        ...
        m = () => {
            ...
            Promise.resolve(r).then(d).catch(r => {
                ...
                n++, e.onFail ? .(n, r), Ol(s).then(() => l() ? void 0 : p()).then(() => {
                    t ? f(r) : m()
                })
            })
        };
...
var Y = class {#
    ...
    scheduleGc() {
        this.clearGcTimeout(), ml(this.gcTime) && (this.#e = W.setTimeout(() => {
            this.optionalRemove()
        }, this.gcTime))
    }
    updateGcTime(e) {
...
var Wl = class extends Y {#
    ...
    s;
    constructor(e) {
        super(), this.#s = !1, this.#o = e.defaultOptions, this.setOptions(e.options), this.observers = [], this.#i = e.client, this.#r = this.#i.getQueryCache(), this.queryKey = e.queryKey, this.queryHash = e.queryHash, this.#t = Kl(this.options), this.state = e.state ? ? this.#t, this.scheduleGc()
    }
    get meta() {
    ...
    setOptions(e) {
        if (this.options = { ...this.#o,
            ...
            e.data !== void 0 && (this.setState(X(e.data, e.dataUpdatedAt)), this.#t = e)
        }
    }
    optionalRemove() {
    ...
    async fetch(e, t) {
        ...
        (this.#e === `infinite` ? Vl(this.options.pages) : this.options.behavior) ? .onFetch(a, this), this.#n = this.state, (this.state.fetchStatus === `idle` || this.state.fetchMeta !== a.fetchOptions ? .meta) && this.#l({
            type: `fetch`,
            ...
            fn: a.fetchFn,
            onCancel: e => {
                e instanceof q && e.revert && this.setState({ ...this.#n,
                    fetchStatus: `idle`
                }), n.abort()
            },
            onFail: (e, t) => {
    ...
    l(e) {
        ...
        this.state = t(this.state), zl.batch(() => {
...
var ql = class extends Y {#
    ...
    r;
    constructor(e) {
        super(), this.#e = e.client, this.mutationId = e.mutationId, this.#n = e.mutationCache, this.#t = [], this.state = e.state || Jl(), this.setOptions(e.options), this.scheduleGc()
    }
    setOptions(e) {
...
var Zl = class extends sl {
    ...
    Ql = class {#
        ...
        s;
        constructor(e = {}) {
            this.#e = e.queryCache || new Zl, this.#t = e.mutationCache || new Yl, this.#n = e.defaultOptions || {}, this.#r = new Map, this.#i = new Map, this.#a = 0
        }
        mount() {
            this.#a++, this.#a === 1 && (this.#o = cl.subscribe(async e => {
        ...
        ensureQueryData(e) {
            let t = this.defaultQueryOptions(e),
                ...
                r = n.state.data;
            return r === void 0 ? this.fetchQuery(e) : (e.revalidateIfStale && n.isStaleByTime(gl(t.staleTime, n)) && this.prefetchQuery(t), Promise.resolve(r))
        }
        getQueriesData(e) {
        ...
        setQueriesData(e, t, n) {
            return zl.batch(() => this.#e.findAll(e).map(({
                queryKey: e
        ...
        refetchQueries(e, t = {}) {
            let n = { ...t,
                ...
                r = zl.batch(() => this.#e.findAll(e).filter(e => !e.isDisabled() && !e.isStatic()).map(e => {
                    ...
                    return n.throwOnError || (t = t.catch(fl)), e.state.fetchStatus === `paused` ? Promise.resolve() : t
                }));
        ...
        defaultQueryOptions(e) {
            ...
            return t.queryHash || = bl(t.queryKey, t), t.refetchOnReconnect === void 0 && (t.refetchOnReconnect = t.networkMode !== `always`), t.throwOnError === void 0 && (t.throwOnError = !!t.suspense), !t.networkMode && t.persister && (t.networkMode = `offlineFirst`), t.queryFn === Ml && (t.enabled = !1), t
        }
    ...
    eu = ({
        ...
        e.unmount()
    }), [e]), (0, B.jsx)($l.Provider, {
        value: e,
        children: t
    })),
    tu = `/assets/styles-CjQ74UaP.css`;
    ...
    ou = wc()({
        head: () => ({
            meta: [{
                ...
                name: `author`,
                content: `Stock Learners`
            }, {
                title: `Stock Learners — Free Live Signals by Gautam Jha`
            }, {
                property: `og:title`,
                content: `Stock Learners — Free Live Signals by Gautam Jha`
            }, {
                name: `twitter:title`,
                content: `Stock Learners — Free Live Signals by Gautam Jha`
            }, {
                name: `description`,
                content: `Join Gautam Jha's free live stock trading channel. Real-time signals, daily market analysis, and live trades on Telegram — 100% free.`
            }, {
                ...
                property: `og:image`,
                content: `https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6174c164-a98f-4eb0-8b10-4e56cd86a760/id-preview-5d4d3eec--7ae9cd9b-c854-4784-aebc-e0386170331a.lovable.app-1785211433736.png`
            }, {
                name: `twitter:image`,
                content: `https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6174c164-a98f-4eb0-8b10-4e56cd86a760/id-preview-5d4d3eec--7ae9cd9b-c854-4784-aebc-e0386170331a.lovable.app-1785211433736.png`
            }, {
        ...
        children: [(0, B.jsx)(`head`, {
            ...
            children: [(0, B.jsx)(`noscript`, {
                children: (0, B.jsx)(`img`, {
                    ...
                    alt: ``,
                    src: `https://www.facebook.com/tr?id=${au}&ev=PageView&noscript=1`
                })
            }), e, (0, B.jsx)($c, {})]
        })]
    })
...
var lu = `modulepreload`,
    ...
    fu = function(e, t, n) {
        ...
        if (t && t.length > 0) {
            ...
            r = o(t.map(t => {
                ...
                if (o.rel = r ? `stylesheet` : lu, r || (o.as = `script`), o.crossOrigin = ``, o.href = t, a && o.setAttribute(`nonce`, a), document.head.appendChild(o), r) return new Promise((e, n) => {
    ...
    pu = {
        IndexRoute: Dc(`/`)({
            ...
            component: kc(() => fu(() =>
                import (`./routes-BIe8D9Jo.js`), []), `component`)
        }).update({
            id: `/`,
            path: `/`,
            getParentRoute: () => ou
...
var xu = g();
(0, z.startTransition)(() => {
    (0, xu.hydrateRoot)(document, (0, B.jsx)(z.StrictMode, {
        children: (0, B.jsx)(bu, {})
    }))
});
export {
